...
const OurMotoData = () => {
    ...
    return (
        <div className="h-fit w-screen py-16 bg-[#f9f9f9]" style={{ backgroundColor: '#f9f9f9' }}>
                ...
                <div className="w-full max-w-6xl grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    {
                        WebsiteDisclaimer && WebsiteDisclaimer.length > 0 ? WebsiteDisclaimer.map((website, index) => (
                            <div key={`${index}-${website._id}`} className="relative group hover-lift bg-white p-6 rounded-lg border border-[#e0e0e0] text-center">
                                <LazyLoadImage
									effect="blur"
									loading="lazy"
									...
									className="w-16 h-16 mx-auto mb-4 transition-transform duration-150 group-hover:scale-110"
									wrapperProps={{
										style: {transitionDelay: `${index * 100}ms`},
									}}
									placeholder = {<div className="w-full h-full bg-gray-200 animate-pulse rounded-full"></div>}
								/>
                                <div>
                                    <h3 className="font-bold text-center text-black mb-2">{website?.header}</h3>
                                    <p className="text-sm" style={{ color: '#666666' }}>{website?.body}</p>
                                </div>

                                {/* Hover Text */}
                                <div className="absolute top-0 left-0 right-0 bottom-0 bg-black bg-opacity-90 text-white p-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-lg flex items-center justify-center">
                            ...
                            <Fragment>
                                ...
                                <div className="relative group hover-lift bg-white p-6 rounded-lg border border-[#e0e0e0] text-center">
                                    <Truck size={48} className="text-black mx-auto mb-4 transition-transform duration-150 group-hover:scale-110" />
                                    <h3 className="font-bold text-lg text-black mb-2">FREE SHIPPING</h3>
                                    <p className="text-sm" style={{ color: '#666666' }}>On all orders over ₹75.00</p>
                                ...
                                <div className="relative group hover-lift bg-white p-6 rounded-lg border border-[#e0e0e0] text-center">
                                    <Clock size={48} className="text-black mx-auto mb-4 transition-transform duration-150 group-hover:scale-110" />
                                    <h3 className="font-bold text-lg text-black mb-2">24/7 SUPPORT</h3>
                                    <p className="text-sm" style={{ color: '#666666' }}>Available to assist you anytime</p>

                                    {/* Hover Text */}
                                    <div className="absolute top-0 left-0 right-0 bottom-0 bg-black bg-opacity-90 text-white p-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-lg flex items-center justify-center">
                                        <p className="text-center text-sm">Our support team is available 24/7 to assist you with any questions.</p>
                                    </div>
                                </div>

                                {/* Third Grid Item - Money Return */}
                                <div className="relative group hover-lift bg-white p-6 rounded-lg border border-[#e0e0e0] text-center">
                                    <CircleDollarSign size={48} className="text-black mx-auto mb-4 transition-transform duration-150 group-hover:scale-110" />
                                    <h3 className="font-bold text-lg text-black mb-2">EASY RETURNS</h3>
                                    <p className="text-sm" style={{ color: '#666666' }}>Hassle-free returns within 30 days</p>

                                    {/* Hover Text */}
                                    <div className="absolute top-0 left-0 right-0 bottom-0 bg-black bg-opacity-90 text-white p-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-lg flex items-center justify-center">
                                        <p className="text-center text-sm">Enjoy hassle-free returns on all purchases within 30 days.</p>
                                    </div>
                                </div>

                                {/* Fourth Grid Item - Order Discount */}
                                <div className="relative group hover-lift bg-white p-6 rounded-lg border border-[#e0e0e0] text-center">
                                    <BadgeIndianRupee size={48} className="text-black mx-auto mb-4 transition-transform duration-150 group-hover:scale-110" />
                                    <h3 className="font-bold text-lg text-black mb-2">BEST PRICES</h3>
                                    <p className="text-sm" style={{ color: '#666666' }}>Exclusive discounts on your orders</p>

                                    {/* Hover Text */}
                                    <div className="absolute top-0 left-0 right-0 bottom-0 bg-black bg-opacity-90 text-white p-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-lg flex items-center justify-center">
                                        <p className="text-center text-sm">Get exclusive discounts during special promotions.</p>
                                    </div>
                                </div>
